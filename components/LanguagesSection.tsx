...
const LanguageIcon: React.FC<{ logoUrl: string; name: string }> = ({ logoUrl, name }) => (
  <div className="group flex flex-col items-center justify-center gap-3 p-4 transition-transform duration-300 hover:scale-110" title={name}>
    ...
    <span className="text-sm font-medium text-platypus-subtle group-hover:text-platypus-text transition-colors duration-300">{name}</span>
  </div>
);
...
const LanguagesSection: React.FC = () => {
  ...
  return (
    <section className="py-16 md:py-20 bg-platypus-secondary">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-extrabold text-platypus-text">Works With Your Favorite Languages & Frameworks</h2>
          <p className="text-lg text-platypus-subtle mt-4 max-w-3xl mx-auto">
        ...
        <div className="mt-20 max-w-4xl mx-auto text-center bg-white p-8 md:p-12 rounded-2xl shadow-xl overflow-hidden relative">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <h3 className="text-2xl md:text-3xl font-extrabold text-platypus-text">Seamlessly Integrates with Your Editor</h3>
            <p className="text-lg text-platypus-subtle mt-4 max-w-xl mx-auto">
