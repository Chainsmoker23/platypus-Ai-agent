...
const CTASection: React.FC = (): React.ReactElement => {
  return (
    <section id="download" className="bg-platypus-primary/10 dark:bg-platypus-dark-background transition-colors duration-300">
      <div className="container mx-auto px-6 py-16 md:py-20">
        <div className="relative max-w-4xl mx-auto text-center bg-white dark:bg-[#0c0c0c] border border-transparent dark:border-gray-800 p-8 md:p-12 rounded-2xl shadow-xl overflow-hidden">
           ...
           <div className="relative z-10 flex flex-col items-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                ...
                <button className="px-8 py-3 bg-platypus-secondary dark:bg-gray-800 text-platypus-text dark:text-platypus-dark-text font-bold rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
