...
const CTASection: React.FC = () => {
  return (
    <section id="download" className="bg-platypus-primary/10">
      <div className="container mx-auto px-6 py-16 md:py-20">
        <div className="relative max-w-4xl mx-auto text-center bg-white p-8 md:p-12 rounded-2xl shadow-xl overflow-hidden">
           ...
           <div className="relative z-10 flex flex-col items-center">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-platypus-text">Ready to Code Smarter?</h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                ...
                <button className="px-8 py-3 bg-platypus-secondary text-platypus-text font-bold rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
