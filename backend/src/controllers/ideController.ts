// FIX: Changed from a type-only import to a value import to correctly resolve Express types. This fixes errors where properties like 'body', 'status', and 'json' were not found on Request and Response objects.
